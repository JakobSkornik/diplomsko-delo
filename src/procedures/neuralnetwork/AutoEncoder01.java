...
public class AutoEncoder01 {
     ...
     */
    public AutoEncoder01(int num_of_nodes, int features, int sample_size, int context_size, double learn_rate, double min_learn_rate, boolean debug, Utilities ut) {
